...
class HomesController extends AppController {
	...
	public $uses = array('Lead','Campaign','CallScript','Rebuttal','Form','Order','Customer','LeadKeyword','Support','CallData','OrderUpsale','CampaignProduct');
	...
	public function index($leadId=null){
		...
		if(isset($this->request->query['campaign_id'])) {
			$data = $this->Campaign->find('first',array('fields'=>'Campaign.id','conditions'=>'Campaign.five9_campaign_id="'.$this->request->query['campaign_id'].'"','recursive'=>-1));
			$id = $data['Campaign']['id'];
		}
		
		(isset($this->request->query['id'])) ? $this->set('leadId',$this->request->query['id']) : $this->set('leadId',$id);
		...
		(isset($this->request->query['campaign_id'])) ? $this->set('campaign_id',$this->request->query['campaign_id']) : $this->set('campaign_id','0');
			//=================== save record for calling start=========
			
		if(isset($this->request->query['disposition_id']) and $this->request->query['disposition_id']==-1){
			
			(isset($this->request->query['campaign_id'])) ? $data['CallData']['campaign_id']=$this->request->query['campaign_id'] : $data['CallData']['campaign_id']='';
			(isset($this->request->query['campaign_name'])) ? $data['CallData']['campaign_name']=$this->request->query['campaign_name'] : $data['CallData']['campaign_name']='';
			(isset($this->request->query['first_name'])) ? $data['CallData']['first_name']=$this->request->query['first_name'] : $data['CallData']['first_name']='';
			(isset($this->request->query['last_name'])) ? $data['CallData']['last_name']=$this->request->query['last_name'] : $data['CallData']['last_name']='';
			(isset($this->request->query['session_id'])) ? $data['CallData']['session_id']=$this->request->query['session_id'] : $data['CallData']['session_id']='';
			(isset($this->request->query['user_name'])) ? $data['CallData']['user_name']=$this->request->query['user_name'] : $data['CallData']['user_name']='';
			(isset($this->request->query['id'])) ? $data['CallData']['lead_id']=$this->request->query['id'] : $data['CallData']['lead_id']='';
			(isset($this->request->query['number'])) ? $data['CallData']['number']=$this->request->query['number'] : $data['CallData']['number']='';
		...
		(isset($this->request->query['disposition_id'])) ? $data['CallData']['disposition_id']=$this->request->query['disposition_id'] : $data['CallData']['disposition_id']='';
		(isset($this->request->query['session_id'])) ? $data['CallData']['callend_session_id']=$this->request->query['session_id'] : $data['CallData']['callend_session_id']='';
		(isset($this->request->query['start_timestamp'])) ? $data['CallData']['callstart_time']=$this->request->query['start_timestamp'] : $data['CallData']['callstart_time']='';
		(isset($this->request->query['end_timestamp'])) ? $data['CallData']['callend_time']=$this->request->query['end_timestamp'] : $data['CallData']['callend_time']='';
		...
		if($ctp_name){
			...
			switch($ctp)
			{
				case 'shipping.ctp':
					...
					if(!$this->request->data['Order']['ship_email']){
						$this->Lead->id=$lead_id;
						$email=$this->Lead->field('email');  
						$this->request->data['Order']['ship_email']=$email;
					}
				...
				case 'billing.ctp':
					...
					if(!$this->request->data['Order']['bill_email']){
						$this->request->data['Order']['bill_email']=$email;
					}
					
					
					// if billing address is same as shipping
					$this->Session->read('shipping_information.Order.ship_fname');
					$billingAddressIsSame=$this->Session->read('shipping_information.Order.billingAddressIsSame');
					if($billingAddressIsSame){
					
						$this->request->data['Order']['bill_fname']=$this->Session->read('shipping_information.Order.ship_fname');
						$this->request->data['Order']['bill_lname']=$this->Session->read('shipping_information.Order.ship_lname');
						$this->request->data['Order']['bill_address1']=$this->Session->read('shipping_information.Order.ship_address1');
						$this->request->data['Order']['bill_address2']=$this->Session->read('shipping_information.Order.ship_address2');
						$this->request->data['Order']['bill_city']=$this->Session->read('shipping_information.Order.ship_city');
						$this->request->data['Order']['bill_state']=$this->Session->read('shipping_information.Order.ship_zip');
						$this->request->data['Order']['bill_zip']=$this->Session->read('shipping_information.Order.ship_phone_number');
						$this->request->data['Order']['bill_country']='US';
					}	
				...
				switch($this->request->data['Order']['SUBMIT'])
				{
					...
					case 'BILLING':
						...
						//================= code for payment =================
							...
							///=======assgin shipping information  for save record
							...
							if(!empty($camp_id)){
								...
								$this->request->data['Order']['ereports_store_id']=$rec['Campaign']['ereports_store_id'];  // ereports payment
								$this->request->data['Order']['ereports_token']=$rec['Campaign']['ereports_token'];
								///======
								$this->request->data['Order']['mediahub_apikey']=$rec['Campaign']['mediahub_apikey']; // media humb api details
								$this->request->data['Order']['mediahub_token']=$rec['Campaign']['mediahub_token'];
								$this->request->data['Order']['publisher_id']=$rec['Campaign']['publisher_id'];
								//// ======
								$this->request->data['Order']['lime_light_username']=$rec['Campaign']['lime_light_username']; // lime light api details
								$this->request->data['Order']['lime_light_password']=$rec['Campaign']['lime_light_password'];
								
								
								// get slected product information
								$this->CampaignProduct->recursive=-2;
								$prodcut_id=$this->request->data['Order']['product_id'];
								$produt_rec=$this->CampaignProduct->findById($prodcut_id);  // get prodcut record 
								
								$this->request->data['Order']['ereports_price']=$produt_rec['CampaignProduct']['total_price'];
								$this->request->data['Order']['lime_light_campaign_id']=$produt_rec['CampaignProduct']['lime_light_campaign_id']; 
								$this->request->data['Order']['lime_light_shipping_id']=$produt_rec['CampaignProduct']['lime_light_shipping_id'];
								$this->request->data['Order']['lime_light_product_id']=$produt_rec['CampaignProduct']['product_id'];
								$this->request->data['Order']['name']=$produt_rec['CampaignProduct']['name'];
								...
								$url = 'https://gateway.sslapplications.net/ynMklop/?' . http_build_query(array(
																									...
																									'pid' => $prodcut_id,
																									'product1_name' =>$this->request->data['Order']['name'],
																									'product1_qty' => 1,
																									'product1_totalprice' =>$this->request->data['Order']['ereports_price'],
																									'test' => 1	
																								));				
													...
													case 2:
														...
														$fields = array(
																		...
																		'ShippingCountry'=>'USA',
																		'TheHash'=>'1369852770',
																		'apikey'=>$this->request->data['Order']['mediahub_apikey'],
																		'token'=>$this->request->data['Order']['mediahub_token']
																		);
																		
																if(count($this->request->data['OrderUpsale'])){
																	$i=1;
																		foreach($this->request->data['OrderUpsale'] as $key=>$value){
												...
												case 3:
														...
														$this->request->data['Order']['upsale_product_id']=$upsale_string;
														
														
														App::import('Vendor','LimeLightProxy');  // integrate lime light
														$proxy = new LimeLightProxy($_SERVER);
														
														 $result = $proxy->createNewOrder($this->request->data);
														 ...
														 if ($result["errorFound"]) {
															...
															$payment_response['message']=$result["orderId"];
														}
	...
	function api()
	{
		...
		$campaginRec=$this->CampaignProduct->find('first',array('fields'=>'CampaignProduct.campaign_id','conditions'=>'CampaignProduct.product_id="'.$data['Lead']['product_id'].'"','recursive'=>-1));
		$data['Lead']['campaign_id']=$campaginRec['CampaignProduct']['campaign_id'];
				...
				$data['Lead']['listname']='newlist';
							...
							$client->__setSoapHeaders($header);
								...
								$res = $client->addRecordToList(array('listName'=>$data['Lead']['listname'], 'listUpdateSettings'=>array('allowDataCleanup'=>FALSE, 'reportEmail'=>'4003@dothejob.org','separator'=>',', 'skipHeaderLine'=>true, 'cleanListBeforeUpdate'=>FALSE, 'crmAddMode'=>'ADD_NEW', 'crmUpdateMode'=>'UPDATE_FIRST','listAddMode'=>'ADD_FIRST', 'fieldsMapping'=>
										  ...
										  'record'=>array('fields'=>array($data['Lead']['phone'],'9782341664','9782341665',$data['Lead']['first_name'],$data['Lead']['last_name'],'',$data['Lead']['address1'],$data['Lead']['city'],$data['Lead']['state'],$data['Lead']['zip_code'],$data['Lead']['address'],$data['Lead']['country'],$data['Lead']['email'],$data['Lead']['id']))
													 ));
